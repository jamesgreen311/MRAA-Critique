...
function sendNotification(data) {
    ...
    if (meetingtype.toLowerCase() === "in person") {
        body += `<br><br><strong>Host Information</strong><br>${inPersonContent}`;
    } else if (meetingtype.toLowerCase() === "virtual") {
        body += `<br><br>Zoom Information <br>${zoomContent}`;
    } else if (meetingtype.toLowerCase() === "hybrid") {
        body += `<br><br>Please RSVP to the host if you plan to attend in person.
            <br><br><strong>Host Information</strong><br>${inPersonContent}
            <br><br>Zoom Information <br>${zoomContent}`
    }
